...
@section('title', 'Créer un Match - Admin SAMAFOOT')

@section('content')
<div>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-green-900">Créer un nouveau match</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select id="home_team_id" 
                        ...
                        @foreach($clubs as $club)
                            <option value="{{ $club->id }}" {{ old('home_team_id') == $club->id ? 'selected' : '' }}>
                                {{ $club->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select id="away_team_id" 
                        ...
                        @foreach($clubs as $club)
                            <option value="{{ $club->id }}" {{ old('away_team_id') == $club->id ? 'selected' : '' }}>
                                {{ $club->name }}
                            </option>
                        @endforeach
                    </select>
